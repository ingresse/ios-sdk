...
public class PaymentService: BaseService {
    ...
    ///   - onSuccess: success callback
    ///   - onError: error callback
    public func doPayPalPayment(request: Request.Shop.PayPalPayment, userToken: String, onSuccess: @escaping (_ response: Response.Shop.Payment) -> Void, onError: @escaping ErrorHandler) {
        let url = URLBuilder(client: client)
            .setPath("shop")
            .addParameter(key: "usertoken", value: userToken)
            .build()
