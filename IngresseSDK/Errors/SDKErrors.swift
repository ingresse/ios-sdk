...
public class SDKErrors: NSObject {
    ...
    let errors = [
        ...
        1109: "Este telefone já foi utilizado para criar ou validar uma conta Ingresse. Insira outro telefone ou entre em contato com a Ingresse <u>clicando aqui</u>.",
        1192: "Este número de telefone já está ativo em outra conta. Entre em contato com a Ingresse <u>clicando aqui</u>",
