#
#  Be sure to run `pod spec lint IngresseSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "IngresseSDK", "IngresseSDK/**/*.{h,m,swift}"
  s.exclude_files = "IngresseSDK/Exclude"
